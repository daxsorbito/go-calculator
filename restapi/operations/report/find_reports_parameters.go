...
// NewFindReportsParams creates a new FindReportsParams object
// no default values defined in spec.
func NewFindReportsParams() FindReportsParams {

	return FindReportsParams{}
}

// FindReportsParams contains all the bound params for the find reports operation
// typically these are obtained from a http.Request
//
// swagger:parameters findReports
type FindReportsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewFindReportsParams() beforehand.
func (o *FindReportsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *FindReportsParams) bindEnd(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *FindReportsParams) validateEnd(formats strfmt.Registry) error {
...
func (o *FindReportsParams) bindStart(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *FindReportsParams) validateStart(formats strfmt.Registry) error {
